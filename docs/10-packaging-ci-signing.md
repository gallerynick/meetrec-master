...
a = Analysis(
    ...
    hiddenimports=[
        "meetrec", "meetrec.ui", "meetrec.asr", "meetrec.keywords",
        "meetrec.summary", "meetrec.audio", "meetrec.storage",
        "ctranslate2", "tokenizers", "onnxruntime", "onnxruntime.capi",
        "av", "sounddevice", "rapidfuzz.distance", "rapidfuzz.fuzz",
        "pypinyin", "jieba", "cryptography.hazmat.bindings._rust",
        "keyring.backends.macOS", "keyring.backends.wincred",
    ],
